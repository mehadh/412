...
class GraphsView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if birth_years:
            ...
            context['year_of_birth_graph'] = "<p>data not find.</p>"
        party_counts = {}
        for voter in voters:
        ...
        if party_counts:
            ...
            context['party_affiliation_graph'] = "<p>data not find.</p>"
        participation_data = {
        ...
        if any(participation_data.values()):
            ...
            context['election_participation_graph'] = "<p>data on chart not find.</p>"
